...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center sideBar px-4 bg-gray-100">
            <div className="bg-white rounded-2xl shadow-lg w-full max-w-4xl flex overflow-hidden">

                <div
                    className="w-1/2 hidden md:flex flex-col justify-center items-center bg-rosterGreen text-white p-6 bg-cover bg-center">
                    <div className="bg-black/50 p-4 borderRadius10 text-center">
                        <h2 className="mainHeading font-bold ">Welcome Back 👋</h2>
                ...
                <div className="w-full md:w-1/2 p-8">
                    <div className=' flex items-center justify-center mb-6'>
                        <h1 className="text-center text-2xl font-bold text-secondary ">Login</h1>
                ...
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50"
                    ...
                    <div className={`bg-white p-6 rounded-lg shadow-2xl w-80 ${modalClass}`}>
                        ...
                        <div className="text-center">
                            <button onClick={closeModal} className="buttonGrey py-2 px-4 rounded-lg">Close</button>
                        </div>
                    </div>
                </div>
            )}
