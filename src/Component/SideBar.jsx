  ...
  return (
    <div className="flex">
      ...
      <div className="flex items-start">
        <div
          className={`h-[100vh] shadow-2xl text-violet-400 text-[18px] transition-all duration-300 bg-gradient-to-b from-violet-600 to-violet-900
            ${open ? "w-[250px]" : "w-[80px]"}`}
        >
          <div className="flex flex-col">
            <div className="flex items-center p-4 w-full justify-around">
              <div className="flex items-center gap-2">
                <div
                  className={`bg-gradient-to-b from-red-100 to-yellow-300 text-white rounded-lg p-[4px] transition-all duration-300 ${
                    !open ? "hidden" : "block"
                  }`}
                >
                ...
                <p
                  className={`text-white text-[24px] font-semibold transition-all duration-300 ${
                    !open ? "hidden" : "block"
                  }`}
                >
                  Rosterly
                ...
                {item.submenu && (
                  <ul
                    className={`overflow-hidden rounded-lg p-1 w-[200px] transition-all duration-300 ${
                      ...
                      open
                        ? "w-full"
                        : "absolute left-[80px] top-50% bg-violet-900 rounded-lg shadow-lg p-2 w-[200px] sm:w-auto"
                    }`}
                  >
